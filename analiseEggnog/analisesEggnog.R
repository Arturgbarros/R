...
#separar letras de uma mesma linha em linhas diferentes
...
#separar os dados 75678|eucariota em colunas distintas tipo 75678|   eucariota
...
dados = rename(dados, especie = coluna2, COGs=...7_nova)#renomeando as colunas
